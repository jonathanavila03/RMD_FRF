...
error_reporting(0);
  ...
  require './examples/database.php';

  $valida_id = $_SESSION['usuario_rut'];
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>RMD</b>-FRF</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <span class="hidden-xs">Jonathan  ?php  echo $user ?    Avila</span>
            </a>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/crea-obra.html"><i class="fa fa-circle-o"></i> Crear Obra</a></li>
            <li><a href="pages/layout/crea-proyecto.html"><i class="fa fa-circle-o"></i> Crear Proyecto</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="avarti.cl">Avarti Software</a>.</strong> All rights
    reserved.
  </footer>
