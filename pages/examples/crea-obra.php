      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../layout/crea-obra.html"><i class="fa fa-circle-o"></i> Crear Obra</a></li>
            <li><a href="../layout/crea-proyecto.html"><i class="fa fa-circle-o"></i> Crear Proyecto</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
